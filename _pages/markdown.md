...
[comment]: <> (permalink: /markdown/)

[comment]: <> (title: "Markdown")
...
[comment]: <> (## Locations of key files/directories)

[comment]: <> (* Basic config options: _config.yml)

[comment]: <> (* Top navigation bar config: _data/navigation.yml)

[comment]: <> (* Single pages: _pages/)

[comment]: <> (* Collections of pages are .md or .html files in:)

[comment]: <> (  * _publications/)
...
[comment]: <> (* Footer: _includes/footer.html)

[comment]: <> (* Static files &#40;like PDFs&#41;: /files/)

[comment]: <> (* Profile image &#40;can set in _config.yml&#41;: images/profile.png)

[comment]: <> (## Tips and hints)

[comment]: <> (* Name a file ".md" to have it render in markdown, name it ".html" to render in HTML.)

[comment]: <> (* Go to the [commit list]&#40;https://github.com/academicpages/academicpages.github.io/commits/master&#41; &#40;on your repo&#41; to find the last version Github built with Jekyll. )

[comment]: <> (  * Green check: successful build)

[comment]: <> (  * Orange circle: building)

[comment]: <> (  * Red X: error)

[comment]: <> (  * No icon: not built)

[comment]: <> (## Resources)

[comment]: <> ( * [Liquid syntax guide]&#40;https://shopify.github.io/liquid/tags/control-flow/&#41;)

[comment]: <> (## Markdown guide)
